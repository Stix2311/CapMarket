...
# df['Volume'].replace(to_replace=0, method='ffill', inplace=True) #No use (michael 1/25/2022)
# df.sort_values('Date', inplace=True) #This will mess up the csv (michael 1/25/2022)
# print(df.head(100))
...
##### CALCUATE NORMALIZED PERCENTAGE CHNAGE OF ALL COLUMNS #####
...
# 128 DATA PER CHUNK EX: 0~127 1ST CHUNK 1~128 2ND CHUNK ETC
# Training data
X_train, y_train = [], []
